// Package k8s provides cloud-agnostic Kubernetes monitoring components.
//
// This package contains reusable PromQL expressions, scrape configs, alerts,
// recording rules, and dashboards for monitoring Kubernetes clusters.
// Cloud-specific packages (eks, gke, aks) extend these base components.
package k8s
